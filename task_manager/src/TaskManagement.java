    ...
    public static void main(String s[]) {
        try {
            ...
            while(true) {
                ...
                System.out.println(
                    "Print 1 to add an entry in the Taskbook," +
                ...
                if(userAction.equals("1")) {
                    ...
                    if(taskBook.containsKey(name)) {
                        System.out.println("The task already exists! Do you want to replace it? y/n");
                    ...
                    System.out.println("Enter Prioriy - 1 Low, 2 Medium, 3 High ");
                ...
                // Option 4: Update a task by name
                    ...
                    // Prompts the user to enter the taskName to update
